...
profile_dir = os.path.join(os.environ["TEMP"], "brave_css_rules_" + str(int(time.time())))
...
try:
    with urllib.request.urlopen("http://localhost:9227/json") as resp:
    ...
    print("Metrics:", res.get("result", {}).get("result", {}).get("value"))
