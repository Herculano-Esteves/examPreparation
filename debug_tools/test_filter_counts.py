"""
debug_tools/test_filter_counts.py
---------------------------------
Inspeciona os números calculados em cada opção de filtro:
- Exames Feitos vs Exames Por Fazer
- Escolha Múltipla vs V/F vs Escrita
"""
...
profile_dir = os.path.join(os.environ["TEMP"], "brave_filter_counts_" + str(int(time.time())))
        ...
        "params": {
            ...
            (() => {
                ...
                return JSON.stringify({
                    stateCompleted: getTxt('count-state-completed'),
                    statePending: getTxt('count-state-pending'),
                    typeChoice: getTxt('count-type-escolha_multipla'),
                    typeBoolean: getTxt('count-type-boolean'),
                    typeWritten: getTxt('count-type-escrita'),
                    totalExams: document.querySelectorAll('#exams-grid .exam-list-row').length
                }, null, 2);
            })()
            """,
            "returnByValue": True
